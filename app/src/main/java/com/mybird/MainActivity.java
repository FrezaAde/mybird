...
import fragments.FragmentDaftarJuara;
...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setBackgroundDrawable(R.drawable.background_01);
		...
		map.put("title", "PROFIL");
		map.put("desc", "Perbarui Profil Anda");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "TIPS");
		map.put("desc", "Berita Seputar Kicau Mania");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "DAFTAR JUARA");
		map.put("desc", "Daftar Juara Lomba Burung");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "RIWAYAT PEMESANAN");
		map.put("desc", "Riwayat Pemesanan Anda");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "LIHAT KERANJANG");
		map.put("desc", "Item Yang Ada di Keranjang");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "KRITIK & SARAN");
		map.put("desc", "Kirim Kritik Saran Anda");
		menuArray.add(map);

		map = new HashMap<String, String>();
		map.put("title", "LOGOUT");
		map.put("desc", "Beralih Akun");
		menuArray.add(map);
        ...
        ImageView imageProfile = (ImageView) menu_header.findViewById(R.id.left_user_image);
	...
	public void set_fragment_page(int position){
		...
		switch (position) {
			...
			case 1:
				...
				break;
			case 2:
				startActivity(new Intent(getApplicationContext(), CobaProfilActivity.class));
				break;
			case 3:
				fragment = new FragmentDaftarJuara();
				break;
			case 4:
