...
public class ConstValue {
	...
	public static String SITE_URL = "http://mybird.silobur.com";
	...
	public static String JSON_SUB_CATEGORY=SITE_URL+"/index.php?component=json&action=get_burungSubCategory";
	public static String JSON_PRODUCTS=SITE_URL+"/index.php?component=json&action=get_products_by_category";
	public static String JSON_PRODUK=SITE_URL+"/index.php?component=json&action=produk";
	public static String JSON_NEWS = SITE_URL+"/components/json/get_burungNews.php";
	...
	public static String NEWS_IMAGE_BIG_PATH=SITE_URL+"/userfiles/news/big/";
	public static String NEWS_IMAGE_SMALL_PATH=SITE_URL+"/userfiles/news/small/";
	public static String NEWS_IMAGE_ICON_PATH=SITE_URL+"/userfiles/news/icon/";
	...
	public static String IMAGE_PROFILE_PATH=SITE_URL+"/userfiles/profile/icon/";

	public static String GCM_SENDER_ID = "720391900040";

	public static String MAIN_PREF = "MyBird";
	public static String CART_PREF = "MyBirdCart";
    ...
    public static ArrayList<HashMap<String, String>> selected_products_list;
